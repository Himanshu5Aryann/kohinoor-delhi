...
export const products: Product[] = [
  {
    ...
    category: "Sofas",
    images: [img.livingRoom1, img.livingRoom2, img.livingRoom6],
    description:
  ...
  },
  {
    ...
    category: "Beds",
    images: [img.bedroom1, img.bedroom2, img.bedroom4],
    description:
  ...
  },
  {
    ...
    category: "Wardrobes",
    images: [img.wardrobe1, img.wardrobe2, img.wardrobe3],
    description:
  ...
  },
  {
    ...
    category: "TV Units",
    images: [img.tvUnit1, img.tvUnit2, img.livingRoom5],
    description:
