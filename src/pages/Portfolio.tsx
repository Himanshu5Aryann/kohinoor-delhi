...
const projects: Project[] = [
  { name: "Chhatarpur Residence", category: "Living Rooms", location: "Chhatarpur, Delhi", scope: "Living room design & furniture", image: img.livingRoom1 },
  { name: "Saket Family Home", category: "Bedrooms", location: "Saket, Delhi", scope: "Bedroom interiors & wardrobes", image: img.bedroom1 },
  { name: "Ram Colony Apartment", category: "Kitchens", location: "Ram Colony, Delhi", scope: "Modular kitchen design", image: img.kitchen2 },
  { name: "Birla A1 Society Home", category: "Full-home Projects", location: "Birla A1 Society, Delhi", scope: "Complete home interior", image: img.livingRoom6 },
  { name: "Greater Kailash Residence", category: "Living Rooms", location: "Greater Kailash, Delhi", scope: "Living & dining furniture", image: img.livingRoom4 },
  { name: "Malviya Nagar Studio", category: "Offices", location: "Malviya Nagar, Delhi", scope: "Home office design", image: img.office1 },
  { name: "Vasant Kunj Apartment", category: "Bedrooms", location: "Vasant Kunj, Delhi", scope: "Master bedroom & storage", image: img.bedroom4 },
  { name: "Chhatarpur Villa", category: "Kitchens", location: "Chhatarpur, Delhi", scope: "Island kitchen & dining", image: img.kitchen3 },
  { name: "South Delhi Penthouse", category: "Full-home Projects", location: "South Delhi", scope: "Complete home interior", image: img.livingRoom5 },
];
  ...
  return (
    <>
      ...
      <section className="relative flex h-[65vh] min-h-[440px] items-end overflow-hidden bg-charcoal text-ivory">
        <img src={img.livingRoom6} alt="Kohinoor Furniture House portfolio" className="absolute inset-0 h-full w-full object-cover" />
