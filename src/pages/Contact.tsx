...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact Kohinoor Furniture House | Chhatarpur, New Delhi"
        description="Get in touch with Kohinoor Furniture House in Chhatarpur, New Delhi for bespoke furniture and interior design consultations."
      />
